...
export function UserIcon(props) {
  return (
    ...
    >
      ...
      />
      <path
        d="M16 3.63C16.8604 3.8503 17.623 4.3507 18.1676 5.05231C18.7122 5.75392 19.0078 6.61683 19.0078 7.505C19.0078 8.39317 18.7122 9.25608 18.1676 9.95769C17.623 10.6593 16.8604 11.1597 16 11.38"
        stroke="correntColor"
        stroke-width="2"
        stroke-linecap="round"
        stroke-linejoin="round"
